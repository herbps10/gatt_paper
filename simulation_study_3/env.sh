...
export SIMULATION_STUDY_SCRIPT_PATH="/gpfs/home/susmah01/gatt_paper/simulation_study_2/simstudy.R"

# Directory to cache intermediate results (e.g., per-task output)
export SIMULATION_CACHE_PATH="/gpfs/scratch/susmah01/gatt_paper/simulation_study_2/"

# Directory to store SLURM log files (stdout and stderr for each job)
export SIMULATION_LOG_PATH="/gpfs/scratch/susmah01/gatt_paper/logs/"

# Directory for final processed results (e.g., combined output)
export SIMULATION_RESULTS_PATH="/gpfs/home/susmah01/gatt_paper/simulation_study_2/results/"

# === SLURM job configuration ===

# Name of the SLURM job (appears in job monitoring commands)
export JOB_NAME="gatt"
