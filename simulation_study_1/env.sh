...
export SIMULATION_STUDY_SCRIPT_PATH="/gpfs/home/susmah01/gatt_paper/simulation_study_1/simstudy.R"

# Directory to cache intermediate results (e.g., per-task output)
export SIMULATION_CACHE_PATH="/gpfs/scratch/susmah01/gatt_paper/simulation_study_1/"
...
export SIMULATION_RESULTS_PATH="/gpfs/home/susmah01/gatt_paper/simulation_study_1/results/"
